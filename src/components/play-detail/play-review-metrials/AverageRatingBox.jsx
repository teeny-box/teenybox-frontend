...
export default function AverageRatingBox({ isLoggedIn, setIsReviewFormOpened, count, averageRate, state, purpose }) {
  // 로그인 필요 알람
        ...
        {state === "공연예정" ? (
          <Tooltip title="공연 예정인 연극에는 리뷰를 작성할 수 없습니다." arrow>
            <div className="review-button">
              <Button color="inherit" state="focused" variant="outlined" disabled>
