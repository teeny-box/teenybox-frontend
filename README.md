...
|  |  |   |
| --- | --- | :--- |
| **회원가입/로그인** | <img src="readme-login.png" height="360" alt="readme 로고"/> <br/>카카오, 네이버, 구글 등 소셜로그인을 통해 간편하게 로그인할 수 있습니다. | <img src="readme-register.png" height="360" alt="readme 로고"/> <br/> 소셜로그인 후 프로필사진, 닉네임, 선호지역 등의 간단한 추가 정보를 입력하여 복잡한 절차 없이 회원가입할 수 있습니다. |
| **연극 리스트 페이지** | |
| **연극 디테일 페이지** | |
